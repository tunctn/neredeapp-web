...
import { transformMovie, transformProviders } from "@util/transform";
...
export const getStaticProps: GetStaticProps = async ({ params: { id } }) => {
  ...
  return { props: { movie, providers }, revalidate: 3600 };
};

export async function getStaticPaths() {
  const [genresResponse, popularMoviesResponse, nowPlayingMoviesResponse] =
    await Promise.all([
      genresCache.getData(),
